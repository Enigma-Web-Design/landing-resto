...
const Header = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center  absolute text-white z-[2] w-full h-[670px] xl:h-[640px] lg:h-[600px] md:h-[540px] sm:h-[500px]  color-white-800">
      ...
      <header className="h-[670px] xl:h-[640px] lg:h-[600px] md:h-[540px] sm:h-[500px]  relative  bg-white-900 overflow-hidden">
        <Swiper
          effect={'cube'}
          grabCursor={true}
          cubeEffect={{
