export default function Section({ position, foodBack }) {
  return (
    ...
    >
      <div className="flex flex-col w-full p-[4vw]  sm:w-1/2 justify-center items-center bg-white bg-opacity-40 sm:bg-opacity-0 text-center ">
        <small className="font-bold text-base">JOIN TODAY</small>
        <h2 className="font-extrabold text-2xl sm:text-3xl mb-4">
          JOIN THE REAL DEAL
        </h2>
        <p className="leading-8 text-sm sm:text-lg font-medium sm:px-[2vw]">
