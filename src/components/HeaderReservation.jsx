...
export default function HeaderReservation({ image, button, title, subtitle }) {
  return (
    <>
      <div className="flex flex-col items-center justify-center  absolute text-white z-[1] w-full h-[670px] xl:h-[640px] lg:h-[600px] md:h-[540px] sm:h-[500px]  color-white-800">
        <h1 className="text-[40px]  sm:text-[90px] font-bold">
          {title || "RESERVATIONS"}
        </h1>
        <h2>{subtitle || "The best of the best."}</h2>
        <button
          className={
            "mt-10 bg-[#b28442] text-white font-bold border p-2 px-20 border-4 outline outline-white outline-4 border-transparent duration-100 hover:border-white " +
            button
          }
        >
          FIND A TABLE
